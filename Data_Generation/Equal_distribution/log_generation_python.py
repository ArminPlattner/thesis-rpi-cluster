...
def generate(
    n_synthetic: int = 14901,
    n_success:   int = 5000,
    out_anomaly: str = "ansible_anomaly_pool_new",
    out_stream:  str = "ansible_full_stream_new.csv",
    ...
    weights  = [0.14, 0.10, 0.14, 0.10, 0.14, 0.14, 0.12, 0.12]
    per_cat  = {c: max(1, int(n_synthetic * w)) for c, w in zip(iac_cats, weights)}
